...
class Avatar implements Serializable
{
    ...
    // ====================== methodes ====================== //
    // ====================================================== //
    //l'entité avatar implemante serializable elle doit donc contenir deux methodes (meme si on fait rien dedans)
    //la methode serialize qui converti les proprieter mon texte en text, comme les images
    //et la methode unserialize qui converti des données texte en objets
    ...
    {
        $this->imageFile = base64_encode($data);
    }
